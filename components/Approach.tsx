    ...
    <section className=" w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            ...
            description = "I will colaborate to map out your goals, target audience, and key functionalities. "
            >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            description = " Once we agree on the plan, I cue my lofi playlist and dive in coding. From initial sketches to polished code, I keep you updated every step of the way.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            description ="Based on the approved design, I'll translate everything into functional code , building your website from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
